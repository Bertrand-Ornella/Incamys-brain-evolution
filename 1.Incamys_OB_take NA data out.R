...
OB.na<-na.omit(Incamys.data)
species<-OB.na$Species_name
...
#Save dataset
write.csv(Incamys.data,'Incamys.data_OB.csv')

#Save tree
write.nexus(tree_Incamys, file = "Incamys_OB_tree.nex")
