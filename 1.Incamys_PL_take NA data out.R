...
######################## Choice of regression OLS check PL vs BM ##########################
...
Incamys.data<-Incamys.data[c(1:14,16)]
PL.na<-na.omit(Incamys.data)
species<-PL.na$Species_name
...
#Save dataset
write.csv(Incamys.data,'Incamys.data_PL.csv')

#Save tree
write.nexus(tree_Incamys, file = "Incamys_PL_tree.nex")
